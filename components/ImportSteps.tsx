  ...
  return (
    <div className="max-w-xl mx-auto space-y-4 pt-4">
      ...
      <div className="grid grid-cols-2 gap-4">
        <button onClick={() => onDecision('APPEND')} className="p-6 bg-white border-2 border-slate-100 rounded-xl hover:border-indigo-500 hover:bg-indigo-50 font-bold text-slate-700 flex flex-col items-center transition-all shadow-sm hover:shadow-md group">
        ...
        <button onClick={() => onDecision('REPLACE')} className="p-6 bg-white border-2 border-slate-100 rounded-xl hover:border-red-500 hover:bg-red-50 font-bold text-slate-700 flex flex-col items-center transition-all shadow-sm hover:shadow-md group">
         ...
         <div className="bg-white p-5 rounded-xl border border-slate-200 shadow-sm">
             ...
             <div className="grid grid-cols-2 gap-4 mb-4 mt-4">
                ...
                <div className="flex flex-col justify-end">
                   ...
                   <div className={`border rounded-lg p-2 text-sm font-mono ${preview[0]?.parsed.includes('Nadal') || preview[0]?.parsed.includes('Błąd') ? 'bg-red-50 border-red-200 text-red-700' : 'bg-emerald-50 border-emerald-200 text-emerald-700'}`}>
                      {preview[0]?.parsed || '---'}
                   </div>
                </div>
             </div>
